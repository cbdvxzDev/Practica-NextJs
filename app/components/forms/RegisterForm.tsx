    ...
    >
      ...
      <div className="flex items-start space-x-2.5 pt-1.5">
        ...
        <label htmlFor="acceptTerms" className="text-[11px] text-brand-muted leading-tight cursor-pointer select-none">
          Acepto los{" "}
          <Link href="/terms" className="text-brand-dark underline underline-offset-2 font-medium">Términos de servicio</Link>{" "}
          y la{" "}
          <Link href="/privacy" className="text-brand-dark underline underline-offset-2 font-medium">Política de privacidad</Link>.
        </label>
      </div>
